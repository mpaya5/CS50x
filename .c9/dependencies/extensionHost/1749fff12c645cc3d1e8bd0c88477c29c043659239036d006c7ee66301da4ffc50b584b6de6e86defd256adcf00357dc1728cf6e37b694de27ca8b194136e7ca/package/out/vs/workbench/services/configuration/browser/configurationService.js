    ...
    class WorkspaceService extends lifecycle_1.Disposable {
        ...
        registerConfigurationSchemas() {
            if (this.workspace) {
                ...
                const allSettingsSchema = { properties: configurationRegistry_1.allSettings.properties, patternProperties: configurationRegistry_1.allSettings.patternProperties, additionalProperties: true, allowsTrailingCommas: true, allowComments: true };
                const userSettingsSchema = this.remoteUserConfiguration ? { properties: Object.assign({}, configurationRegistry_1.applicationSettings.properties, configurationRegistry_1.windowSettings.properties, configurationRegistry_1.resourceSettings.properties), patternProperties: configurationRegistry_1.allSettings.patternProperties, additionalProperties: true, allowsTrailingCommas: true, allowComments: true } : allSettingsSchema;
                const machineSettingsSchema = { properties: Object.assign({}, configurationRegistry_1.machineSettings.properties, configurationRegistry_1.machineOverridableSettings.properties, configurationRegistry_1.windowSettings.properties, configurationRegistry_1.resourceSettings.properties), patternProperties: configurationRegistry_1.allSettings.patternProperties, additionalProperties: true, allowsTrailingCommas: true, allowComments: true };
                const workspaceSettingsSchema = { properties: Object.assign({}, configurationRegistry_1.machineOverridableSettings.properties, configurationRegistry_1.windowSettings.properties, configurationRegistry_1.resourceSettings.properties), patternProperties: configurationRegistry_1.allSettings.patternProperties, additionalProperties: true, allowsTrailingCommas: true, allowComments: true };
                ...
                if (3 /* WORKSPACE */ === this.getWorkbenchState()) {
                    const folderSettingsSchema = { properties: Object.assign({}, configurationRegistry_1.machineOverridableSettings.properties, configurationRegistry_1.resourceSettings.properties), patternProperties: configurationRegistry_1.allSettings.patternProperties, additionalProperties: true, allowsTrailingCommas: true, allowComments: true };
