    ...
    suite('keybindingIO', () => {
        test('serialize/deserialize', () => {
            function testOneSerialization(keybinding, expected, msg, OS) {
                let usLayoutResolvedKeybinding = new usLayoutResolvedKeybinding_1.USLayoutResolvedKeybinding(keyCodes_1.createKeybinding(keybinding, OS), OS);
            ...
            function testOneDeserialization(keybinding, _expected, msg, OS) {
                ...
                let expected = keyCodes_1.createKeybinding(_expected, OS);
        ...
        test('deserialize scan codes', () => {
            assert.deepEqual(keybindingParser_1.KeybindingParser.parseUserBinding('ctrl+shift+[comma] ctrl+/'), [new scanCode_1.ScanCodeBinding(true, true, false, false, 60 /* Comma */), new keyCodes_1.SimpleKeybinding(true, false, false, false, 85 /* US_SLASH */)]);
        });
