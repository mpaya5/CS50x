...
define(["require", "exports", "vs/base/common/lifecycle", "vs/base/common/uri", "vs/platform/configuration/common/configuration", "vs/platform/files/common/files", "vs/platform/workspace/common/workspace", "vs/platform/registry/common/platform", "vs/workbench/common/contributions", "vs/base/common/map", "vs/base/common/errors", "vs/platform/notification/common/notification", "vs/nls", "vs/platform/opener/common/opener"], function (require, exports, lifecycle_1, uri_1, configuration_1, files_1, workspace_1, platform_1, contributions_1, map_1, errors_1, notification_1, nls_1, opener_1) {
    ...
    platform_1.Registry.as(contributions_1.Extensions.Workbench).registerWorkbenchContribution(WorkspaceWatcher, 3 /* Restored */);
});
