 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/common/path", "vs/base/common/amd", "vs/base/common/platform", "vs/base/common/resources", "vs/base/common/uri", "vs/workbench/services/search/node/fileSearch"], function (require, exports, assert, path, amd_1, platform, resources_1, uri_1, fileSearch_1) {
    "use strict";
    ...
    const ROOT_FOLDER_QUERY_36438 = [
        { folder: uri_1.URI.file(path.normalize(amd_1.getPathFromAmdModule(require, './fixtures2/36438'))) }
    ];
    ...
    suite('FileSearchEngine', () => {
        ...
        test('Files: extraFiles only', function (done) {
            ...
            const engine = new fileSearch_1.Engine({
                ...
                folderQueries: [],
                extraFileResources: [
                    uri_1.URI.file(path.normalize(path.join(amd_1.getPathFromAmdModule(require, './fixtures'), 'site.css'))),
                    uri_1.URI.file(path.normalize(path.join(amd_1.getPathFromAmdModule(require, './fixtures'), 'examples', 'company.js'))),
                    uri_1.URI.file(path.normalize(path.join(amd_1.getPathFromAmdModule(require, './fixtures'), 'index.html')))
                ],
                filePattern: '*.js'
            });
            let count = 0;
        ...
        test('Files: no dupes in nested folders', function (done) {
            ...
            const engine = new fileSearch_1.Engine({
                ...
                folderQueries: [
                    { folder: EXAMPLES_FIXTURES },
                    { folder: resources_1.joinPath(EXAMPLES_FIXTURES, 'subfolder') }
                ],
