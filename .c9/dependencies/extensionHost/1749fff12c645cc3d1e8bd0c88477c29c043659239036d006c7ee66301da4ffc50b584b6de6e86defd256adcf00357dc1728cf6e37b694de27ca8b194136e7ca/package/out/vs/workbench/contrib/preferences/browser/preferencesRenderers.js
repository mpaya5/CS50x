    ...
    let UnsupportedSettingsRenderer = class UnsupportedSettingsRenderer extends lifecycle_1.Disposable {
                ...
                for (const section of settingsGroup.sections) {
                    for (const setting of section.settings) {
                        ...
                        if (configuration) {
                            ...
                            markerData.push(Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range, { message: nls.localize('unknown configuration setting', "Unknown Configuration Setting") }));
                        }
                    }
                }
            }
        ...
        handleLocalUserConfiguration(setting, configuration, markerData) {
            if (this.workbenchEnvironmentService.configuration.remoteAuthority && (configuration.scope === 2 /* MACHINE */ || configuration.scope === 5 /* MACHINE_OVERRIDABLE */)) {
                markerData.push(Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range, { message: nls.localize('unsupportedRemoteMachineSetting', "This setting cannot be applied now. It will be applied when you open local window.") }));
            }
        }
        ...
        handleWorkspaceFolderConfiguration(setting, configuration, markerData) {
            ...
            if (configuration.scope === 3 /* WINDOW */) {
                markerData.push(Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range, { message: nls.localize('unsupportedWindowSetting', "This setting cannot be applied now. It will be applied when you open this folder directly.") }));
            }
        }
        generateUnsupportedApplicationSettingMarker(setting) {
            return Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range, { message: nls.localize('unsupportedApplicationSetting', "This setting can be applied only in application user settings") });
        }
        generateUnsupportedMachineSettingMarker(setting) {
            return Object.assign({ severity: markers_1.MarkerSeverity.Hint, tags: [1 /* Unnecessary */] }, setting.range, { message: nls.localize('unsupportedMachineSetting', "This setting can only be applied in user settings in local window or in remote settings in remote window.") });
        }
        dispose() {
            this.markerService.remove('preferencesEditor', [this.settingsEditorModel.uri]);
            super.dispose();
