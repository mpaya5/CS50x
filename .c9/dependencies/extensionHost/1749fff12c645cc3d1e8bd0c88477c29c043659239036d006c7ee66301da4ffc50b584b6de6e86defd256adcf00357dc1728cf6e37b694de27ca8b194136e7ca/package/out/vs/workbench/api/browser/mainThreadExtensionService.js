...
define(["require", "exports", "vs/base/common/severity", "vs/workbench/api/common/extHostCustomers", "vs/workbench/api/common/extHost.protocol", "vs/workbench/services/extensions/common/extensions", "vs/platform/notification/common/notification", "vs/nls", "vs/base/common/actions", "vs/workbench/services/extensionManagement/common/extensionManagement", "vs/platform/extensionManagement/common/extensionManagementUtil", "vs/platform/windows/common/windows", "vs/workbench/contrib/extensions/common/extensions", "vs/base/common/cancellation"], function (require, exports, severity_1, extHostCustomers_1, extHost_protocol_1, extensions_1, notification_1, nls_1, actions_1, extensionManagement_1, extensionManagementUtil_1, windows_1, extensions_2, cancellation_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    let MainThreadExtensionService = class MainThreadExtensionService {
        constructor(extHostContext, extensionService, notificationService, extensionsWorkbenchService, windowService, extensionEnablementService) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (this._extensionEnablementService.isEnabled(missingInstalledDependency)) {
                    this._notificationService.notify({
                        ...
                        actions: {
                            primary: [new actions_1.Action('reload', nls_1.localize('reload', "Reload Window"), '', true, () => this._windowService.reloadWindow())]
                        }
                    });
                }
                else {
