...
define(["require", "exports", "vs/base/common/color", "vs/workbench/contrib/terminal/common/terminalColorRegistry"], function (require, exports, color_1, terminalColorRegistry_1) {
     ...
     */
    function handleANSIOutput(text, linkDetector, themeService) {
     ...
     */
    function appendStylizedStringToContainer(root, stringContent, cssClasses, linkDetector, customTextColor, customBackgroundColor) {
