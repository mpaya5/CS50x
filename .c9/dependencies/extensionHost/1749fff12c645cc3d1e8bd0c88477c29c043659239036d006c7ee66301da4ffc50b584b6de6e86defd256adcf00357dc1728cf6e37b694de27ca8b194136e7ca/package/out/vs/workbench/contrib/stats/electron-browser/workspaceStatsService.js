...
define(["require", "exports", "crypto", "vs/platform/files/common/files", "vs/platform/workspace/common/workspace", "vs/workbench/services/environment/common/environmentService", "vs/platform/windows/common/windows", "vs/platform/notification/common/notification", "vs/platform/quickinput/common/quickInput", "vs/workbench/services/textfile/common/textfiles", "vs/base/common/network", "vs/platform/workspaces/common/workspaces", "vs/nls", "vs/base/common/severity", "vs/base/common/resources", "vs/platform/instantiation/common/extensions", "vs/workbench/contrib/stats/common/workspaceStats", "vs/workbench/contrib/stats/electron-browser/workspaceStats"], function (require, exports, crypto, files_1, workspace_1, environmentService_1, windows_1, notification_1, quickInput_1, textfiles_1, network_1, workspaces_1, nls_1, severity_1, resources_1, extensions_1, workspaceStats_1, workspaceStats_2) {
    ...
    let WorkspaceStatsService = class WorkspaceStatsService {
        constructor(fileService, contextService, environmentService, windowService, notificationService, quickInputService, textFileService) {
        ...
        doHandleWorkspaceFiles(folder, workspaces) {
            ...
            if (workspaces.length === 1) {
                ...
                this.notificationService.prompt(severity_1.default.Info, nls_1.localize('workspaceFound', "This folder contains a workspace file '{0}'. Do you want to open it? [Learn more]({1}) about workspace files.", workspaceFile, 'https://go.microsoft.com/fwlink/?linkid=2025315'), [{
                        ...
                        run: () => this.windowService.openWindow([{ workspaceUri: resources_1.joinPath(folder, workspaceFile) }])
                    }], { neverShowAgain });
            }
                ...
                this.notificationService.prompt(severity_1.default.Info, nls_1.localize('workspacesFound', "This folder contains multiple workspace files. Do you want to open one? [Learn more]({0}) about workspace files.", 'https://go.microsoft.com/fwlink/?linkid=2025315'), [{
                        ...
                        run: () => {
                            this.quickInputService.pick(workspaces.map(workspace => ({ label: workspace })), { placeHolder: nls_1.localize('selectToOpen', "Select a workspace to open") }).then(pick => {
                                if (pick) {
                                    this.windowService.openWindow([{ workspaceUri: resources_1.joinPath(folder, pick.label) }]);
                                }
                            });
                        }
                    }], { neverShowAgain });
